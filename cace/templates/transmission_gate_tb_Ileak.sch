...
C {devices/vsource.sym} 670 -240 0 0 {name=Vin value=0}
C {devices/vsource.sym} 1030 -430 0 0 {name=Ven value=0}
...
C {devices/vsource.sym} 1030 -260 0 0 {name=Ven1 value=1.2}
...
C {devices/code_shown.sym} -320 -540 0 0 {name=MODEL1 only_toplevel=true
...
"}
C {devices/code_shown.sym} -290 -370 0 0 {name=NGSPICE1 only_toplevel=true 
value="
.control
save all 
op
...
let Iin=I(Vp2)
let Ileak=I(Vp5)
echo $&Iout $&Iin $&Ileak > CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
.endc
"}
