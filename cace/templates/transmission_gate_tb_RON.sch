...
N 500 -260 500 -220 {
lab=VSS}
C {devices/code_shown.sym} -360 -550 0 0 {name=MODEL only_toplevel=true
...
"}
C {devices/code_shown.sym} -350 -260 0 0 {name=NGSPICE only_toplevel=true 
value="
.control
save all 
op
...
C {devices/vsource.sym} 760 -190 0 0 {name=Ven_p value=CACE\{Vp\}}
...
C {devices/vsource.sym} 760 -20 0 0 {name=Ven_n value=CACE\{Vn\}}
