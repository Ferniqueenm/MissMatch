...
.endc
"}
C {devices/vsource.sym} 110 -620 0 0 {name=Vpow value=3.0}
...
C {devices/vsource.sym} 110 -430 0 0 {name=Vin value=3.0}
C {devices/vsource.sym} 190 -620 0 0 {name=Ven value=0}
C {devices/gnd.sym} 190 -570 0 0 {name=l3 lab=GND}
C {devices/gnd.sym} 110 -390 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} 110 -480 1 0 {name=p1 sig_type=std_logic lab=V_in}
C {devices/lab_pin.sym} 190 -660 1 0 {name=p2 sig_type=std_logic lab=en_p}
...
C {devices/vsource.sym} 190 -430 0 0 {name=Ven1 value=3.0}
C {devices/gnd.sym} 190 -390 0 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} 190 -470 1 0 {name=p5 sig_type=std_logic lab=en_n}
...
C {transmission_gate_hv.sym} -50 40 0 0 {name=x1}
